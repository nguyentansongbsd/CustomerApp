...
{
    public class DatCocContentViewViewModel : ListViewBaseViewModel2<ReservationModel>
    {
        public string Keyword { get; set; }

        public DatCocContentViewViewModel()
        {
            PreLoadData = new Command(() =>
            {
                ...
                FetchXml = $@"<fetch version='1.0' count='15' page='{Page}' output-format='xml-platform' mapping='logical' distinct='false'>
                              <entity name='quote'>
                                ...
                                <link-entity name='contact' from='contactid' to='customerid' visible='false' link-type='inner' alias='d'>
