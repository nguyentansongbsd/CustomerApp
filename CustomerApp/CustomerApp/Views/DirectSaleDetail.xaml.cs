...
namespace CustomerApp.Views
{
    ...
    public partial class DirectSaleDetail : ContentPage
    {
        ...
        {
            LoadingHelper.Show();
            UnitInfoPage unitInfo = new UnitInfoPage(viewModel.Unit.productid);
        ...
        private async Task LoadUnit(Guid unitId)
        {
            ...
            viewModel.UnitStatusCode = Data.GetStatusCodeById(viewModel.Unit.statuscode.ToString());
            if (!string.IsNullOrWhiteSpace(viewModel.Unit.bsd_direction))
            {
                viewModel.UnitDirection = Data.GetDiretionById(viewModel.Unit.bsd_direction);
            }
            else
            {
            ...
            {
                viewModel.UnitView = Data.GetViewByIds(viewModel.Unit.bsd_viewphulong);
            }
            else
            {
