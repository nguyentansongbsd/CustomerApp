...
namespace CustomerApp.Controls
{
    ...
    public partial class LookUpMultipleOptions : Grid
    {
        ...
        {
            InitializeComponent();
            this.Entry.SetBinding(MainEntry.PlaceholderProperty, new Binding("Placeholder") { Source = this });
            this.Entry.SetBinding(MainEntry.TextProperty, new Binding("Text") { Source = this });
        }
