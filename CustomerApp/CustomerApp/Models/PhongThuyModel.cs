...
namespace CustomerApp.Models
{
    public class PhongThuyModel : BaseViewModel
    {
        ...
        public int nam_sinh
        {
            get => _nam_sinh; set
            {
                _nam_sinh = value; OnPropertyChanged(nameof(nam_sinh));
                if (value != 0)
                {
        ...
        public PhongThuyModel()
        {
            ...
            //Danh sach huong
            lst_huong = new ObservableCollection<string>() { Language.direction_north, Language.direction_south, Language.direction_east, Language.direction_west, Language.direction_north_east, Language.direction_north_west, Language.direction_south_east, Language.direction_south_west };
